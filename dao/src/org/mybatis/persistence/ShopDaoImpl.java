...
public class ShopDaoImpl implements ShopDao {
	...
	public List<Shop> list(Shop shop) {
		...
		return this.sqlSessionTemplate.selectList(
				"org.mybatis.persistence.ShopMapper.list", shop);
	}
	...
	public void insert(Shop shop) {
		...
		this.sqlSessionTemplate.insert(
				"org.mybatis.persistence.ShopMapper.insert", shop);
	...
	public void update(Shop shop) {
		...
		this.sqlSessionTemplate.update(
				"org.mybatis.persistence.ShopMapper.update", shop);
	}

	@Override
	public void delete(int shopNo) {
		this.sqlSessionTemplate.delete(
				"org.mybatis.persistence.ShopMapper.delete", shopNo);
	}

	@Override
	public Shop select(int shopNo) {
		return this.sqlSessionTemplate.selectOne(
				"org.mybatis.persistence.ShopMapper.select", shopNo);
	}
}
