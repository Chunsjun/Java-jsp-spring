...
*/            .append("        document.getElementById('form_search').submit();").append("\n")
      ...
      if (startPageNo > PAGE_BLOCK_COUNT) {
         navigator.append("<li><a href=\"").append("javascript:goPage(1);")
               .append("\">").append("처음").append("</a></li>").append("\n");
      }

      if (this.pageNo > 1) {
         navigator.append("<li><a href=\"")
               .append("javascript:goPage(" + (this.pageNo - 1) + ");")
               .append("\">").append("이전").append("</a></li>").append("\n");
      }
      ...
      if (startPageNo > PAGE_BLOCK_COUNT) {
         ...
         navigator
               ...
               .append("\">").append("...").append("</a></li>").append("\n");
      }
      ...
      for (int i = startPageNo; i <= endPageNo; i++) {
         if (i != this.pageNo) {
            navigator.append("<li><a href=\"")
                  ...
                  .append("\">").append(i).append("</a></li>").append("\n");
         } else {
//            navigator.append("<font style='color: #A00000'><b>" + i + "</b></font>\n");
            navigator.append("<li class='active'><a href=\''>" + i + "</a></li>");
         }
...
//            navigator.append(" | ");
      ...
      if (this.pageNo < totalPageCount) {
         navigator.append("<li><a href=\"")
               .append("javascript:goPage(" + (this.pageNo + 1) + ");")
               .append("\">").append("다음").append("</a></li>").append("\n");
      }

      if (currentPageNo < lastPageNo) {
         navigator.append("<li><a href=\"")
               .append("javascript:goPage(" + totalPageCount + ");")
               .append("\">").append("끝").append("</a></li>").append("\n");
      }
      
      navigator.append("</ul>").append("\n")
      .append("</div>");
